...
<body>
  ...
  <section class="home-section">
    ...
    <tr class="overview-tr">
      ...
      <tr class="overview-tr">
        <td>Address</td>
        <td><input type="text" class="oview_col" name="LicenceNo" value="<?php echo $address ?>" /></td>
      </tr>
      ...
      if (isset($_POST['search'])) {
        ...
        $query = "SELECT Point_Balance, Account_Status FROM driver where Licence_No= '$id'";
        $query2 = "SELECT name,NIC,LicenceNo,address  FROM licencedetails where LicenceNo= '$id'";
